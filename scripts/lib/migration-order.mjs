...
/**
 * Migration order check (ADR-008). Migrations must be appended, never inserted
 * between existing ones: filenames are NNNN_name.sql with strictly increasing,
 * unique numeric prefixes. Inserting a lower-numbered migration after peers have
 * applied higher ones is how environments drift; this gate blocks it.
 */
